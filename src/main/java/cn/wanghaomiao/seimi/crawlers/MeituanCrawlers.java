 ...
 */
@Crawler(name = "meituancrawler")
public class MeituanCrawlers extends BaseSeimiCrawler {
    ...
    public List<Request> startRequests() {
        ...
        collection = collectionMapper.selectByPrimaryKey(3);
        Rule rule = ruleMapper.selectByPrimaryKey(collection.getRuleId());
        Request request = RequestUtil.getRequest(collection, rule, "meituan");
    ...
    public void meituan(Response response) throws XpathSyntaxErrorException{
        ...
        if (parentRule.contains("@href") || parentRule.contains("@src")){
           ...
           // if (sel != null && sel.size() != 0){
             //   for (Object o:sel) {
                    ...
                    url = "http://waimai.meituan.com" + url;
